...
@section('content')
   <div class="container pt-5 mb-5">
       ...
       @endif
       <h2 class="pt-4 mb-4">Register System for Customer Managers</h2>

       <form action="{{route('auth.register')}}" method="POST" class="offset-mb-4 col-sm-5" style="padding: 25px; border-radius: 10px; background: #eff2f4; box-shadow: 0px 0px 7px #c0c0c0;">
           @csrf
           ...
           <div class="form-group">
            ...
            <div class="form-group pt-3">
                <label for="pin" class="lablel">Personal Identification Number</label>
                <input type="password" placeholder="*******" name="pin" class="form-control @error('pin') is-invalid @enderror">
       ...
       <div class="pt-4">
            Already have an account <a href="{{route('auth.login')}}" class="mb-4 pt-5">Login</a>
       </div>
   </div>
@endsection
